...
void CWebHyDrationBridge_add_required_text_by_id(CWebHyDrationBridge *self, const char * id);


void CWebHyDrationBridge_add_required_text_number_by_id(CWebHyDrationBridge *self, const char * id);
