...
typedef struct CWebHydrationSearchResultNamespace {
    ...
    CWebHyDrationSearchResult * (*search_by_index)(CWebHyDrationBridge *self,int index);
    ...
    cJSON* (*cJSON_from_first_element_of_search)(CWebHyDrationBridge *self,const char *name,...);
