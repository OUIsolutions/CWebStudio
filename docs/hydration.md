...
The HyDration mechanic is a mechanism to generate front-end code in C, based on the idea of controlling the browser by creating JavaScript.
...
This example demonstrates the basic usage of HyDration to create interactive web pages.